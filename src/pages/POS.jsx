...
export default function POS() {
  ...
  return (
    <div className="h-[calc(100vh-62px)] overflow-hidden bg-[#f7f7f7] flex flex-col">
      ...
      {/* ───────────────── STEP 2 & 3: MENU + REVIEW share a persistent sidebar ───────────────── */}
      {(step === 'menu' || step === 'review') && (
        <div className="flex-1 flex overflow-hidden">
          {/* LEFT SIDEBAR — running order, stays visible on Menu AND Review steps */}
          <div className="w-[300px] flex-shrink-0 bg-white border-r-2 border-gray-100 flex flex-col">
            ...
            <div className="p-3.5 border-t-2 border-gray-100 flex-shrink-0">
              ...
              {step === 'menu' ? (
                ...
                <button
                  onClick={() => setStep('menu')}
                  className="w-full py-3 rounded-xl font-black text-sm text-maroon bg-orange-50 hover:bg-orange-100 transition-all"
                >
                  ← Edit Order
                </button>
              )}
          ...
          {/* RIGHT SIDE — switches between Menu grid and Review form */}
